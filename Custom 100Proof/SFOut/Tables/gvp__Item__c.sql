CREATE TABLE [SFOut].[gvp__Item__c] (
    ...
    [gvp__Alcohol_by_Volume__c]             DECIMAL (10, 2)   NULL,
	...
	[Active_PMT__c]                         VARCHAR(50)    NULL,
	[Active_LSB__c]                         VARCHAR(50)    NULL,
	[Active_LMWA__c]                        VARCHAR(50)    NULL,
	[Organic__c]                            VARCHAR(50)    NULL,
	[Gluten_Free__c]                        VARCHAR(50)    NULL,
	[Preservative_Free__c]                  VARCHAR(50)    NULL,
	[Vegan_Friendly__c]                     VARCHAR(50)    NULL,
	[Lower_Carb__c]                         VARCHAR(50)    NULL,
	[LM_Item_Number__c]                     NVARCHAR (200)    NULL,
	[LSB_Item_Number__c]                    NVARCHAR (200)    NULL,
	[PMT_Item_Number__c]                    NVARCHAR (200)    NULL,
