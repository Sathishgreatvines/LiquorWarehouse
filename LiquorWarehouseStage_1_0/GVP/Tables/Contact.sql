CREATE TABLE [GVP].[Contact] (
    ...
    [gvp__Salesman_Key__c]             VARCHAR (255)     NULL,
    [gvp__Salesman_Number__c]          VARCHAR (255)     NULL,
    [gvp__Age_Calculated__c]           DECIMAL (6, 2)   NULL,
    [gvp__Attributes__c]               VARCHAR (255)     NULL,
    [gvp__Company__c]                  NVARCHAR(255)     NULL,
    [gvp__Contact_Method__c]           NVARCHAR (255)     NULL,
    [gvp__Customer_Key__c]             VARCHAR (255)     NULL,
    [gvp__Email_Key__c]                VARCHAR (255)     NULL,
