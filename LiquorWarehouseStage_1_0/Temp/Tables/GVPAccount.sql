CREATE TABLE Temp.GVPAccount (
    ...
    [gvp__Account_Groups__c]                    NVARCHAR (255)  NULL,
    [gvp__Account_Format__c]                    NVARCHAR (255)  NULL,
    [gvp__Account_Key_List__c]                  NVARCHAR (MAX) NULL,
    [gvp__Account_Key__c]                       NVARCHAR (255) NULL,
    [gvp__Account_Rank__c]                      DECIMAL(18,1) NULL,
    [gvp__Account_Segment__c]                   CHAR (18) NULL,
    [gvp__Account_Sold__c]                      nvarchar(255) NULL,
    [gvp__Active__c]                            nvarchar(255)  NULL,
    [gvp__Area_Code__c]                         CHAR (10)  NULL,
    [gvp__BDN_Account_Type__c]                  VARCHAR (255)  NULL,
    [gvp__BDN_AddDate__c]                       DATE  NULL,
    [gvp__BDN_ChangeDate__c]                    DATE  NULL,
    [gvp__BDN_Date_of_Data__c]                  char(12)  NULL,
    [gvp__BDN_Food_Type__c]                     NVARCHAR (255)  NULL,
    [gvp__BDN_Id__c]                            VARCHAR (50)  NULL,
    [gvp__BDN_Last_Update__c]                   DATE  NULL,
    [gvp__BDN_Phone__c]                         VARCHAR (60)  NULL,
    [gvp__BDN_Primary_Contact__c]               NVARCHAR (255)  NULL,
    [gvp__BDN_Trade_Channel__c]                 NVARCHAR (255)  NULL,
    [gvp__Banner_Name__c]                       NVARCHAR (255)  NULL,
    [gvp__Banner__c]                            NVARCHAR (255)  NULL,
    [gvp__Beer_Indicator__c]                    VARCHAR (255)  NULL,
    [gvp__Billing_Contact__c]                   NVARCHAR (255)  NULL,
    [gvp__Company_Id__c]                        NVARCHAR (255)  NULL,
    [gvp__Company_Size_Code__c]                 NVARCHAR (255)  NULL,
    [gvp__Consumer_Demo__c]                     NVARCHAR (255)  NULL,
    [gvp__County__c]                            NVARCHAR (50)  NULL,
    [gvp__Credit_Available__c]                  decimal(16,2)   NULL,
    [gvp__Credit_Limit__c]                      decimal(16,2)   NULL,
    [gvp__Credit_Status__c]                     nvarchar(255)  NULL,
    ...
    [gvp__CustomerPriority__c]                  NVARCHAR(255)  NULL,
    [gvp__DBA__c]                               NVARCHAR (100)  NULL,
    [gvp__Decision_Maker__c]                    CHAR(18)  NULL,
    [gvp__Delivery_Day_Time__c]                 NVARCHAR(255)  NULL,
    ...
    [gvp__Distributor_Team__c]                  NVARCHAR (255)  NULL,
    [gvp__Distributor__c]                       CHAR(18)  NULL,
    [gvp__Division_Id__c]                       nvarchar(255)  NULL,
    [gvp__Division__c]                          NVARCHAR(50)  NULL,
    [gvp__External_Id__c]                       nvarchar(255)  NULL,
    [gvp__Family_Owner_Code__c]                 VARCHAR (20)  NULL,
    [gvp__Franchise__c]                         nvarchar(255) NULL,
    [gvp__Geocode_Unavailable__c]               nvarchar(255) NULL,
    ...
    [gvp__Key_Account_Chain_Indicator__c]       NVARCHAR (255)  NULL,
    [gvp__Key_Account__c]                       nvarchar(255) NULL,
    ...
    [gvp__Latitude_Longitude_Precision_Code__c] NVARCHAR (255)  NULL,
    [gvp__Latitude__c]                          decimal(23, 11)  NULL,
    [gvp__License_Expiration__c]                DATE  NULL,
    [gvp__License_Number__c]                    VARCHAR (100)  NULL,
    [gvp__License_Type__c]                     nvarchar(255)  NULL,
    [gvp__Liquor_Indicator__c]                  nvarchar(255)  NULL,
    [gvp__Longitude__c]                         decimal(23, 11) NULL,
    [gvp__MSA_Code__c]                          VARCHAR (5)  NULL,
    [gvp__MSA_Name__c]                          nvarchar(255)  NULL,
    [gvp__Marketing_Group__c]                   CHAR(18)  NULL,
    [gvp__Marketing_Group_Code__c]              VARCHAR (20)  NULL,
    [gvp__Marketing_Group_Name__c]              nvarchar(255)  NULL,
    [gvp__Marketing_Group_Non_Corp_Owned__c]    NVARCHAR (255)  NULL,
    [gvp__Number_of_units_sold__c]              decimal(19, 1)  NULL,
    [gvp__NumberofLocations__c]                 decimal(19, 1)  NULL,
    [gvp__On_Premise_Indicator__c]              nvarchar(255)  NULL,
    [gvp__Other_Rep__c]                         nvarchar(255)  NULL,
    [gvp__Outlet_Number__c]                     VARCHAR (20)  NULL,
    [gvp__Outlet_Place_Name__c]                 NVARCHAR (100)  NULL,
    [gvp__Override_Parent_Account__c]           nvarchar(255)  NULL,
    ...
    [gvp__Placement_Id_List__c]                 NVARCHAR (MAX)  NULL,
    [gvp__Primary_Contact__c]                   nvarchar(255)  NULL,
    [gvp__Primary_Email__c]                     nvarchar(255)  NULL,
    [gvp__Region_Id__c]                         nvarchar(255)  NULL,
    [gvp__Region__c]                            nvarchar(255)  NULL,
    [gvp__Resale_Number__c]                     nvarchar(255)  NULL,
    [gvp__Shipment_Depletion_Start_Date__c]     DATE  NULL,
    [gvp__Shipment_Depletion_Type__c]           nvarchar(255)  NULL,
    [gvp__Source_File__c]                       VARCHAR (100)  NULL,
    [gvp__Status_Indicator__c]                  NVARCHAR (255)  NULL,
    [gvp__Store_FTE_s__c]                       decimal(8, 2)  NULL,
    [gvp__Store_Number_of_Registers__c]         decimal(7, 1)  NULL,
    [gvp__Store_Square_Footage__c]              decimal(10, 2)  NULL,
    [gvp__Store_Volume_Annual__c]               nvarchar(255)  NULL,
    [gvp__Store_Volume_Weekly__c]               decimal(10,2)  NULL,
    [gvp__Sub_Trade_Channel__c]                 nvarchar(255)  NULL,
    ...
    [gvp__Wine_Indicator__c]                    nvarchar(255)  NULL,
    ...
    [gvp__RAD_2009__c]                          DECIMAL(18,4)  NULL,
    [gvp__RAD_2010__c]                          DECIMAL(18,4)  NULL, 
