...
(
  ...
  RecordTypeId char(18) not null,
	...
	gvp__Points__c decimal(19,1) null,
	gvp__Email_Summary_Sent_Date__c datetime null,
	gvp__Send_Email_Summary__c varchar(255) null,
	gvp__Geolocation__Latitude__s decimal(17,14) null,
	gvp__Geolocation__Longitude__s decimal(17,14) null,
	gvp__Possible_Points__c decimal(19,1) null,
	gvp__Plan_Possible_Points__c nvarchar(255) null,
	gvp__Points_Since_Last_Survey__c nvarchar(255)  null,
	gvp__Previous_Survey__c char(18) null,
	gvp__Distance_m__c decimal(16,1) null,
	gvp__Submitted_Date_Time__c datetime null,
	gvp__Mobile_Survey__c varchar(255) null,
	gvp__Source__c nvarchar(255) null,
	gvp__Account_Team__c char(18) null,
	gvp__Audited__c nvarchar(255) null,
	gvp__Manager_1__c nvarchar(255) null,
	gvp__Manager_2__c nvarchar(255) null,
	gvp__Manager_3__c nvarchar(255) null,
	gvp__Audit_Notes__c nvarchar(MAX) null,
	gvp__Audit_Status__c nvarchar(255) null,
	gvp__Audited_Survey__c char(18) null,
	gvp__Sales_Team_Division__c char(18) null,
	gvp__Alternate_User_1__c nvarchar(255) null,
	gvp__Alternate_User_2__c nvarchar(255) null,
	gvp__Alternate_User_3__c nvarchar(255) null,
	...
	CurrencyIsoCode varchar(10) null DEFAULT 'USD',
        gvp__Most_Recent__c varchar(255) null,
	gvp__Export__c nvarchar(255),
