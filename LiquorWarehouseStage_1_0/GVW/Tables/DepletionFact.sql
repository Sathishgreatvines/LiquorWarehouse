CREATE TABLE [GVW].[DepletionFact] (
    ...
    [OnOrder]             DECIMAL(18, 4)  NULL,
    [Adjustments]           DECIMAL(18, 4)   NULL,
    [InBond]              DECIMAL(18, 4)   NULL,
    [Receipts]             DECIMAL(18, 4)   NULL,
    [WholesaleSales]      DECIMAL(18, 4)   NULL,
    [TransfersIn]         DECIMAL(18, 4)   NULL,
    [TransfersOut]        DECIMAL(18, 4)   NULL,
    ...
    [Breakage] DECIMAL(18, 4) NULL, 
    [MilitaryOffPremise] DECIMAL(18, 4) NULL, 
    [MilitaryOnPremise] DECIMAL(18, 4) NULL, 
    [NonRetailSales] DECIMAL(18, 4) NULL, 
    [Samples] DECIMAL(18, 4) NULL, 
    [SubDistributorSales] DECIMAL(18, 4) NULL, 
    [SupplierReturns] DECIMAL(18, 4) NULL, 
    [TotalOffPremise] DECIMAL(18, 4) NULL, 
    [TotalOnPremise] DECIMAL(18, 4) NULL, 
    [Transportation] DECIMAL(18, 4) NULL, 
    [UnclassifiedSales] DECIMAL(18, 4) NULL, 
