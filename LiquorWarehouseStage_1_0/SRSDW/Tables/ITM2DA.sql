...
(
	...
	[CASEGTIN] varchar(16) NULL,
	[RETGTIN] varchar(16) NULL,
	[ACTDATE] varchar(10) NULL,
	[DEADATE] varchar(10) NULL,
	...
	CONSTRAINT [PK_ITM2DA] PRIMARY KEY (ITEM)
)