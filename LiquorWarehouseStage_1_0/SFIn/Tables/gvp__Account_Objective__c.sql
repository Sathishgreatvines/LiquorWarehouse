CREATE TABLE [SFIn].[gvp__Account_Objective__c] (
    ...
    [gvp__Box_URL__c]                      NVARCHAR (255)   NULL,
    [gvp__Brand__c]                        char (18)    NULL,
    [gvp__Alternate_User_1__c]             nvarchar(255)    NULL,
    [gvp__Cases_per_Year__c]               DECIMAL (18, 0)  NULL,
    ...
    [gvp__Is_Master_Objective__c]          nvarchar(255)    NULL,
    ...
    [gvp__Priority__c]                     VARCHAR (255)    NULL,
    [gvp__Product_Name__c]                 NVARCHAR (255)   NULL,
    [gvp__Product_Set__c]                  char (18)    NULL,
    [gvp__Program_Name__c]                 NVARCHAR (255)   NULL,
    ...
    [gvp__Survey_Question_Points__c]       NVARCHAR (255) NULL,
