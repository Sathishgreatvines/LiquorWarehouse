...
CREATE TABLE "gd_account_dim" (
		...
		"a__account_retail_dim__account_annual_volume" VARCHAR(512),
		"a__account_retail_dim__account_bdn_add_date" VARCHAR(512),
		"a__account_retail_dim__account_bdn_change_date" VARCHAR(512),
		"a__account_retail_dim__account_bdn_data_of_data" VARCHAR(512),
		"a__account_retail_dim__account_bdn_id" VARCHAR(512),
		"a__account_retail_dim__account_bdn_last_update" VARCHAR(512),
		"a__account_retail_dim__account_company_size" VARCHAR(512),
		"a__account_retail_dim__account_consumer_demographic" VARCHAR(512),
		"a__account_retail_dim__account_customer_number" VARCHAR(512),
		"a__account_retail_dim__account_dba_name" VARCHAR(512),
		"a__account_retail_dim__account_distributor_name" VARCHAR(512),
		"a__account_retail_dim__account_distributor_rep" VARCHAR(512),
		"a__account_retail_dim__account_distributor_team" VARCHAR(512),
		"a__account_retail_dim__account_family_owner_code" VARCHAR(512),
		"a__account_retail_dim__account_immediate_parent_county_fips" VARCHAR(512),
		"a__account_retail_dim__account_immediate_parent_state" VARCHAR(512),
		"a__account_retail_dim__account_immediate_parent_state_fips" VARCHAR(512),
		"a__account_retail_dim__account_license_number" VARCHAR(512),
		"a__account_retail_dim__account_outlet_number" VARCHAR(512),
		"a__account_retail_dim__account_outlet_place_name" VARCHAR(512),
		"a__account_retail_dim__account_primary_contact" VARCHAR(512),
		"a__account_retail_dim__account_primary_email" VARCHAR(512),
		...
		"f__account_retail_dim__account_number_of_ftes" NUMERIC(12,2),
		"f__account_retail_dim__account_number_of_locations" NUMERIC(12,2),
		"f__account_retail_dim__account_number_of_registers" NUMERIC(12,2),
		"f__account_retail_dim__account_square_footage" NUMERIC(12,2),
		"f__account_retail_dim__account_weekly_volume" NUMERIC(12,2),
		"f__create_date" INTEGER,
...
CREATE TABLE "gd_acct_univ_dim" (
		...
		"a__acct_univ_retail_dim__acct_univ_annual_volume" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_bdn_add_date" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_bdn_change_date" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_bdn_data_of_data" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_bdn_id" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_bdn_last_update" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_company_size" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_consumer_demographic" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_customer_number" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_dba_name" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_distributor_name" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_distributor_rep" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_distributor_team" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_family_owner_code" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_immed_parent_county_fips" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_immed_parent_state" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_immed_parent_state_fips" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_license_number" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_outlet_number" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_outlet_place_name" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_primary_contact" VARCHAR(512),
		"a__acct_univ_retail_dim__acct_univ_primary_email" VARCHAR(512),
		...
		"a__bevpath_account_name" VARCHAR(512),
		"a__bevpath_account_segment" VARCHAR(512),
		"a__bevpath_attribute1" VARCHAR(512),
		"a__bevpath_attribute10" VARCHAR(512),
		"a__bevpath_attribute2" VARCHAR(512),
		"a__bevpath_attribute3" VARCHAR(512),
		"a__bevpath_attribute4" VARCHAR(512),
		"a__bevpath_attribute5" VARCHAR(512),
		"a__bevpath_attribute6" VARCHAR(512),
		"a__bevpath_attribute7" VARCHAR(512),
		"a__bevpath_attribute8" VARCHAR(512),
		"a__bevpath_attribute9" VARCHAR(512),
		"a__bevpath_classification" VARCHAR(512),
		"a__bevpath_connection_name" VARCHAR(512),
		"a__company_custom_1" VARCHAR(512),
		"a__company_custom_2" VARCHAR(512),
		"a__company_id" VARCHAR(512),
		"a__company_key" VARCHAR(512),
		...
		"f__acct_univ_retail_dim__acct_univ_no_of_ftes" NUMERIC(12,2),
		"f__acct_univ_retail_dim__acct_univ_no_of_registers" NUMERIC(12,2),
		"f__acct_univ_retail_dim__acct_univ_number_of_locations" NUMERIC(12,2),
		"f__acct_univ_retail_dim__acct_univ_square_footage" NUMERIC(12,2),
		"f__acct_univ_retail_dim__acct_univ_weekly_volume" NUMERIC(12,2),
		"f__create_date" INTEGER,
...
CREATE TABLE "gd_survey_fact" (
		...
		"f__rpt_from_date" INTEGER,
		"f__start_date" INTEGER,
		"f__survey_answer_attachments" NUMERIC(16,2),
		"f__survey_answer_currency" NUMERIC(16,2),
		"f__survey_answer_custom_currency_1" NUMERIC(16,2),
		"f__survey_answer_custom_fact_1" NUMERIC(16,2),
		"f__survey_answer_custom_fact_2" NUMERIC(16,2),
		"f__survey_answer_custom_fact_3" NUMERIC(16,2),
		"f__survey_answer_custom_fact_4" NUMERIC(16,2),
		"f__survey_answer_custom_fact_5" NUMERIC(16,2),
		"f__survey_answer_match_tgt_pts" NUMERIC(12,2),
		"f__survey_answer_number" NUMERIC(16,2),
		"f__survey_answer_percent" NUMERIC(15,2),
		"f__survey_answer_points" NUMERIC(12,2),
		"f__survey_custom_currency_1" NUMERIC(16,2),
		"f__survey_custom_currency_2" NUMERIC(12,2),
		"f__survey_custom_number_1" NUMERIC(16,2),
		"f__survey_custom_number_2" NUMERIC(16,2),
